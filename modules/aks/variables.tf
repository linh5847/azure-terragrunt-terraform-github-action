...
variable "resource_group_id" {
  description = "specifies an Azure resource-group ID"
  type        = string
  default     = ""
}

variable "location" {
  description = "scecifies an Azure location/region"
  type        = string
  default     = ""
}
...
variable "environment" {
  description = "specifies an environment name ie dev, stage, prod"
  type        = string
  default     = ""
}

variable "sku_tier" {
  description = "specifies AKS sku-tier ie Free or Paid"
  type        = string
  default     = "Free"

  validation {
    condition     = contains(["Free", "Paid"], var.sku_tier)
    error_message = "Must be either 'Free' or 'Paid' only."
  }
}

variable "kubernetes_version" {
  description = "specifies a kubernetes cluster version"
  type        = string
  default     = "1.31.0"
}
...
# Azure User Assignment Identity
...
variable "min_count" {
  description = "specifies a minimum number of node available"
  type        = number
  default     = 1
}

variable "max_count" {
  description = "specifies a maximum number of node available"
  type        = number
  default     = 6
}
...
variable "network_plugin" {
  type        = string
  default     = "azure" //at module set to azure value
  description = "Network plugin to use for networking."
  nullable    = false

  validation {
    condition     = contains(["azure", "kubenet", "none"], var.network_plugin)
    error_message = "Must be either 'azure', 'kubenet' or 'none' only."
  }
}
...
variable "network_policy" {
  ...
  validation {
    ...
    error_message = "Must be one of 'azure', 'calico' or 'cilium' only."
  }
} // At the module, set value to azure
